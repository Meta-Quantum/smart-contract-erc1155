...
describe("MetaQuantum ERC1155, NFT Token contract", async () => {
  ...
  describe("Basic value of the MetaQuantum NFT ERC1155", async () => {
    ...
    it("Should be the Deployer of the owner", async () => {
        ...
        const metaQuantumERC1155 = await upgrades.deployProxy(MetaQuantumERC1155,["MetaQuantumERC1155","MQNFT","https://ribdvbmipikj.usemoralis.com/?/{id}.json", "https://ribdvbmipikj.usemoralis.com/collection.json", accounts[1].address,accounts[1].address,1000000,10000]);
